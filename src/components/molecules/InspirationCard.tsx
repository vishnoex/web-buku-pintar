...
const InspirationCard: React.FC<InspirationCardProps> = ({
  ...
  if (loading) {
    return (
      <div className="rounded-lg bg-white shadow-sm animate-pulse flex flex-col w-60">
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg bg-card shadow-sm transition-all hover:shadow-md flex flex-col w-60">
